...
no_symmetry = let poly = motzkin*g
    ...
    JuMP.set_optimizer(m, scs_optimizer(max_iters=20_000, eps=1e-7, accel=20))
...
wedderburn_dec = let poly = motzkin*g, G = PermGroup(perm"(1,2)"), action = VariablePermutation()
